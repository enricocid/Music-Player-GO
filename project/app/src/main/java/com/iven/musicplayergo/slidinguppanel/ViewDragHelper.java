...
class ViewDragHelper {
     ...
     */
    static final int EDGE_RIGHT = 1 << 1;

    /**
     * Edge flag indicating that the top edge should be affected.
     */
    static final int EDGE_TOP = 1 << 2;

    /**
     * Edge flag indicating that the bottom edge should be affected.
     */
    static final int EDGE_BOTTOM = 1 << 3;
    ...
    boolean shouldInterceptTouchEvent(MotionEvent ev) {
        ...
        switch (action) {
            case MotionEvent.ACTION_DOWN: {
                ...
                if ((edgesTouched) != 0) {
                    mCallback.onEdgeTouched(edgesTouched, pointerId);
                }
                break;
            }
    ...
    public static abstract class Callback {
         ...
         * {@link #STATE_SETTLING} and the view capture will not fully end until it comes to a
         * complete stop. If neither of these methods is invoked before <code>onViewReleased</code> returns,
