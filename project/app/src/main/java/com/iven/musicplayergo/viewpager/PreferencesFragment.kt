...
class PreferencesFragment : PreferenceFragmentCompat(),
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        findPreference<Preference>(getString(R.string.equalizer_pref))?.onPreferenceClickListener =
            this
    ...
    override fun onPreferenceClick(preference: Preference?): Boolean {
        when (preference?.key) {
            ...
            getString(R.string.equalizer_pref) -> mMediaPlayerHolder.openEqualizer(
                requireActivity()
            )
