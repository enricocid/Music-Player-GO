...
object ThemeHelper {
    ...
    val accents = arrayOf(
        ...
        Pair(first = R.color.red_300, second = R.style.BaseTheme_Red300),
        Pair(first = R.color.pink_300, second = R.style.BaseTheme_Pink300),
        Pair(first = R.color.purple_300, second = R.style.BaseTheme_Purple300),
        Pair(first = R.color.deep_purple_300, second = R.style.BaseTheme_DeepPurple300),
        Pair(first = R.color.indigo_300, second = R.style.BaseTheme_Indigo300),
        Pair(first = R.color.blue_300, second = R.style.BaseTheme_Blue300),
        Pair(first = R.color.light_blue_300, second = R.style.BaseTheme_LightBlue300),
        Pair(first = R.color.cyan_300, second = R.style.BaseTheme_Cyan300),
        Pair(first = R.color.teal_300, second = R.style.BaseTheme_Teal300),
        Pair(first = R.color.green_300, second = R.style.BaseTheme_Green300),
        Pair(first = R.color.light_green_300, second = R.style.BaseTheme_LightGreen300),
        Pair(first = R.color.lime_300, second = R.style.BaseTheme_Lime300),
        Pair(first = R.color.amber_300, second = R.style.BaseTheme_Amber300),
        Pair(first = R.color.orange_300, second = R.style.BaseTheme_Orange300),
        Pair(first = R.color.deep_orange_300, second = R.style.BaseTheme_DeepOrange300),
        Pair(first = R.color.brown_300, second = R.style.BaseTheme_Brown300),
        Pair(first = R.color.blue_grey_300, second = R.style.BaseTheme_BlueGrey300)
    )
